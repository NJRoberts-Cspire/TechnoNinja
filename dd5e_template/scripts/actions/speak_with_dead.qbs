...
on_activate():
    slot_level = use_spell_slot(Owner, 3, 'Speak with Dead')
    if slot_level == -1:
        return
    name = Owner.name
    log('{{name}} grants a corpse a semblance of life; it can answer up to 5 questions about its life and knowledge')
