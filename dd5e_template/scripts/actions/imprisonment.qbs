...
on_activate():
    ...
    for targ in failures:
        name = targ.name
        log('{{name}} is imprisoned (choose form: burial, chaining, hedged prison, minimus containment, or slumber)')
    for targ in successes:
        name = targ.name
        log('{{name}} resisted Imprisonment')
