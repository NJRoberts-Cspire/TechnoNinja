# Puppet Binder
## "I am not controlling anyone. I am making an offer the body has accepted on the mind's behalf."

## Overview

There are things in Tesshari that polite society has agreed, collectively, not to look at directly. The puppet technology of the Hollow Author is the largest and most current of these. Everyone knows puppets exist. Everyone knows the Author uses them. Everyone knows that the technique for creating and operating them came from somewhere — from some tradition or some practitioner who discovered that the Echomind's connection to its physical shell was not as permanent or exclusive as the Iron Sutra suggested. The technique did not appear fully formed in the Author's hands. It was developed. Someone developed it. That development is a history the Sutensai has worked very hard to suppress, and which exists anyway, in fragments, in the practices of those who came to the same discoveries independently.

The Puppet Binder is a player character class because the techniques that make puppets possible are not exclusively the Author's. They can be practiced by individuals — learned, refined, and used in ways that are not the Author's methods, though the structural resemblance is unmistakable. At lower levels, the Puppet Binder works with prepared vessels: bodies that have been made receptive through biological modification, or recently deceased physical forms whose organic-cybernetic integration is still active enough to accept external control. They extend their Echomind into these forms, operating them from a distance, and the sensation is reported as deeply strange by practitioners who attempt to describe it. You are inside something that is not you. You feel what it feels. You act through hands that are not yours. Some practitioners report that the boundary, over time, becomes unclear.

The moral weight of this practice is present in the class text because it must be. The Puppet Binder has chosen to develop an ability that is structurally identical, in its advanced forms, to the technique of Tesshari's most feared and reviled hidden enemy. The differences matter — the distinction between a practitioner who works with constructed vessels or the willing deceased and the Author who subverts the living is real, meaningful, and the entire ethical basis of the class. The differences also narrow as the practitioner advances. The Possessor subclass does not maintain that distinction at its highest levels. The class text does not pretend this is not happening. It is the class of those who have looked at what the power actually is — what it does at its limit — and decided to pursue it anyway, carrying whatever justification for that decision they have managed to build and knowing that the justification will be tested.

Every intelligence service in Tesshari monitors known Puppet Binders. The Sutensai maintains a comprehensive list. Korrath has practitioners in his service and a secondary team watching them. The Hollow Author keeps a close eye on independent Puppet Binders for several reasons, not all of them threatening — an independent practitioner who develops the technique far enough represents both a potential recruit and a potential threat, and the Author wants to know which.

## The Puppet Binder in the World

The Architect who builds purpose-made vessels and never touches a living mind can make a legitimate case for their practice as a form of remote labor — the puppet as sophisticated tool, operated rather than controlled. This argument holds up better with the Resonants than with anyone else. It holds up worst with people who have met the Hollow Author's work up close. The structural similarity is impossible to fully argue away, and the Architect knows this, and their professional life is organized around the challenge of demonstrating the distinction through consistent behavior.

The Network practitioner — the Puppet Binder who maintains multiple vessels simultaneously — is a particular kind of uncanny. You never know if you're speaking to a body with someone in it. The Network's vessels move like people, respond like people, and are not people in the full sense at the moment of operation. Network practitioners in the Wire Market are a known phenomenon: the person across the table from you may be somewhere else entirely, watching through these eyes, hearing through these ears, and ready to stand up and walk away while the original body remains seated in another district entirely. This is useful for commerce. It is unsettling in ways that the Wire Market has not fully normalized.

The Possessor is the one the Sutensai watches most carefully and the one that the Hollow Author has, in documented cases, attempted to specifically recruit. The Possessor is following the path that ends at what the Author is. Whether they get there — whether they choose that, whether the progression of the ability simply makes it accessible without making it inevitable — is the question the class is built around. Every Possessor is answering it, whether they mean to or not.
...
### The Possessor — "All Bodies Are Vessels. I Am the Proof."

The Possessor has followed the practice to where it goes. They began with constructed vessels and deceased forms and have advanced toward what the practice can actually do at its limit: the temporary occupation of living minds. This is not sanitized in the class text. The Possessor is doing what the Hollow Author does, on a smaller scale, with whatever ethical constraints they have built and continue to maintain. Those constraints are being tested at every level. Some Possessors maintain them completely. Some discover that what they told themselves about the constraints was easier to believe before they knew what possession actually felt like.

**Level 3: Living Proximity**
...
**Level 3: Weak Vessel**
You can attempt to occupy a living creature in a significantly impaired state: unconscious, incapacitated, or under 25% hit points. Make an Intelligence check contested by the target's Wisdom saving throw (DC = your Puppet Binder save DC). On success, you occupy the target as if it were a standard vessel for up to 1 minute. The target is aware of the occupation and can attempt to expel you each round (Wisdom saving throw). When expelled, you cannot attempt to occupy that creature again for 24 hours. This costs 2 Threads.

**Level 6: Extended Grip**
Your occupation of living vessels becomes stronger. When occupying a living vessel (via Weak Vessel or higher features), the target's expulsion saving throw DC increases by 2. Additionally, you can now maintain occupation of a willing living vessel (a creature who has consented) for up to 1 hour without any saving throw by the subject.

**Level 10: Occupation**
You can now attempt to occupy a living creature that is not impaired. Spend 3 Threads and make your Intelligence check against the target's Wisdom saving throw. On success, you occupy the target for up to 10 minutes. The target is aware they are occupied and can attempt to expel you each round. The target retains their own awareness — they experience everything you do with their body. When this feature is used, the target is not a puppet in the Hollow Author's sense — they are fully conscious and experiencing the violation in real time. This is a significant line. Whether crossing it is ever justified is the question the Possessor lives with.

**Level 14: The Deep Claim**
Once per long rest, spend 6 Threads to make an Occupation attempt against a living creature that, on a failure of their saving throw, lasts for 1 hour with no expulsion saves permitted. The target is fully aware throughout. When this effect ends, they remember everything. They can describe what you did. They know what it felt like. They will not forget. This is, mechanically and narratively, the feature that makes the Possessor what they are. If there is a line between this and the Hollow Author's practice, it is thinner here than it has ever been. The Possessor knows this.

---

### The Network — "I Am Several Places at Once"

The Network Puppet Binder maintains multiple vessels simultaneously, each specialized, each deployed differently, each operating as a distinct presence in the world while the original body sits quietly somewhere and manages the connections. It is, in the language of the Wire Market, a distributed operation. It is, in the language of the Iron Sutra, a spiritual fragmentation that the text did not anticipate. It is, in practical terms, the most logistically powerful version of the practice — the ability to be in three districts, four conversations, and one battlefield at the same time.

**Level 3: Efficient Threading**
...
## Roleplaying the Puppet Binder

**The Mirror Problem:** The Puppet Binder's practice looks like the Hollow Author's practice. It is structurally the same practice at a technical level. Every Puppet Binder must have an answer for this — not for others, but for themselves. What is the actual distinction? Is it intent? Is it the nature of the subject? Is it the question of consent? These distinctions are real, but they are ethical arguments, not technical ones, and ethical arguments get tested by difficult situations. When the situation arises where using the technique on a living person would prevent a catastrophe — what is the answer then?

**The Experience of Occupation:** Being in a vessel is strange. Practitioners describe it differently but consistently: the sense of operating through something that is not you, that has its own physical history, its own residual habits. Some vessels carry residue of whatever or whoever they were before. What does your character do with the strangeness of that experience? Do they compartmentalize? Do they find it fascinating? Have they started to prefer it?

**The Surveillance State of Being You:** Every intelligence service in Tesshari knows about Puppet Binders and monitors the known ones. Your character has chosen to develop one of the most politically sensitive abilities in the world. Who knows what you are? What are you hiding, and from whom? What concessions have you made to avoid scrutiny, and what have those concessions cost you?

**The Hollow Author's Shadow:** The Author uses this technique. They may be aware of your existence. They may have opinions about independent practitioners. Whether the Author sees you as a peer, a threat, a recruit, or a loose end is a question that looms over the class in ways that become increasingly urgent as you advance.

## Connections to the Ascension War

Korrath the Unbroken employs Network practitioners as spies and Architects as combat support. He is sufficiently ruthless to also employ Possessors for intelligence work and has done so, with the knowledge kept extremely close. His official public position is that the Hollow Author's puppet technique is monstrous. His operational record is more nuanced.

Vaen of the Empty Hand finds the Puppet Binder practice philosophically repugnant in a specific way: it treats the Echomind as a location rather than a presence — as something that can be moved, displaced, distributed. His theology holds the Echomind as sacred and singular. The Puppet Binder's practice suggests the Echomind is neither. Vaen wants a philosophical debate with a senior Puppet Binder more urgently than almost anything else on his theological agenda.

The Hollow Author maintains awareness of all known independent Puppet Binders. The Author's approach to any specific Puppet Binder depends on their assessment: practitioners who seem likely to develop toward the Author's methods are monitored for recruitment opportunity; practitioners who seem likely to develop toward understanding and countering the Author's methods are prioritized for elimination. The distinction the Author makes is not ethical but operational. The Author is not troubled by peers. The Author is troubled by effective opposition.
