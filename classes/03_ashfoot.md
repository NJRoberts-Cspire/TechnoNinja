# Ashfoot
## "You want to know what war looks like from the bottom? It looks like this. It has always looked like this."

## Overview

The Ashfoot are the working-class soldiers of Tesshari — the people for whom combat is not a profession of honor but a condition of survival. They are not selected for martial training. They do not serve lords by formal oath. They are not born into the Caste of Steel's upper ranks. They are the people who live in the Broken Reaches' lower territories, who exist in the margins between the warlords' formal armies, and who have learned to fight because the alternative was to die without putting up a struggle. They are militia fighters, common soldiers, Hollow Poor warriors, resistance members, and village defenders. The name comes from a Tesshari slang term for the lowest-caste soldiers — the ones who march through ash and mud while the Ironclad ride at the front. Ashfoot took the name back. Most things the nobility uses as an insult end up becoming something else when the people it's aimed at decide to own it.

An Ashfoot does not have access to quality forge work. Their enhancements are whatever they could afford, salvage, or receive from a sympathetic Forge Tender — which means they are mismatched, partially integrated, held together with substitute resonant alloys, and frequently not precisely calibrated. This is, in practical terms, a significant disadvantage. But Ashfoot have been compensating for disadvantage their entire lives, and they have developed an approach to combat that treats improvisation not as a workaround but as a core method. An Ironclad uses the right tool for each situation because they have the right tools. An Ashfoot uses whatever is at hand, and they have become supernaturally good at making whatever is at hand sufficient.

What the Ashfoot know about combat that the nobility does not: it is mostly waiting and fear, punctuated by moments of appalling violence that nobody on either side is truly prepared for. The Ironclad's kata system was built to manage this reality by converting it into form — turn the chaos into discipline, the fear into procedure. The Ashfoot manage the same reality by going through it rather than over it. They know that fear does not go away if you name it correctly. They know that the right attack is the one that hits, not the one that looks correct. They know that the soldier who survives is often not the best-trained one but the one who stayed calm when everything went sideways and found a way to make the worst moment slightly less final.

The Ashfoot in the Broken Reaches are both essential and overlooked — the second category because of the first. No lord's army functions without common soldiers. No territory holds without the people who live there being willing to defend it. But the Caste hierarchy does not count Ashfoot in the ledgers of military honor. Their deaths are tallied in unit numbers, not names. Their victories are attributed to the samurai who commanded them. The Iron Sutra's theology allows for the Echominds of low-caste soldiers to reach the Iron Afterlife — it does not suggest that those Echominds deserve the same quality of resonant passage. The Ashfoot know what they are worth to the system. Some of them have decided to be worth more than that anyway.

## The Ashfoot in the World

The Caste of Steel regards the Ashfoot with the particular combination of dependency and condescension that characterizes the powerful's relationship with the essential. They need Ashfoot to fill armies, defend territory, and perform the work that samurai cannot be asked to do without political complication. They do not want Ashfoot to organize, develop independent military competence, or start asking questions about why the hierarchy exists. An Ashfoot who becomes extraordinarily skilled is a problem — they represent both a resource (useful, deployable) and a threat (the living proof that the Caste hierarchy's martial justification is not as absolute as claimed).

The Iron Sutra treats Ashfoot soldiers with official compassion and practical negligence. The Sutra's texts on the sanctity of all Echominds are lengthy and sincere. The Sutra's allocation of resources for quality forge work among the Hollow Poor is minimal and contingent. A Sutensai priest stationed with an Ashfoot unit provides resonance assessment and limited enhancement maintenance — but they are not expected to give the same quality of spiritual attention to a low-caste soldier's Echomind that they would give to a samurai's. The best Sutensai priests ignore this expectation. The average ones do not.

Among their own communities, Ashfoot are the protectors, the proven ones, the people you want on your side when something goes wrong. Their social status in low-caste communities is high — not because the hierarchy grants it, but because the people around them have seen what they can do. In the Broken Reaches' constant low-grade warfare, a skilled Ashfoot fighter is the difference between a village that survives a raid and one that doesn't. This creates a kind of community-rooted honor that runs entirely outside the Caste system — unofficial, unrecognized, and often more deeply felt than any formal honorific.
...
**Level 17: Salvage Weapon Mastery**
Improvised and salvage weapons in your hands are no longer inferior substitutes — they are your weapons, and you have made them exceptional. All improvised and salvage weapons you wield deal maximum damage on a roll of 19 or 20 (critical hit). Additionally, you can use salvage weapons as focus items for any Ashfoot class feature that requires a weapon, regardless of the weapon's original purpose.
...
### Path of Salvage and Spike — "You've got better gear than me. That's useful. When I take it."
...
### Path of the Iron Formation — "One soldier is a body. Ten soldiers are a wall."

Formation fighters are the Ashfoot who have internalized the fundamental military truth: individuals die; coordinated groups survive. They have developed their skills specifically around fighting in concert with allies — reading the group's needs, plugging gaps, creating opportunities for others, and holding positions that the group needs held. They are not the most spectacular fighters. They are the reason the fight is still going in the third hour when the spectacular fighters have burned out.
...
### Path of the Ghost Ground — "They can't hold what they can't find. They can't fight what they can't see."
...
## Roleplaying the Ashfoot

The central truth of the Ashfoot character is that they know the hierarchy is wrong — not as an abstract political position but as a lived experience. They have been on the receiving end of the Caste of Steel's prioritization of the high-caste. They know what it looks like when a samurai's Echomind receives careful spiritual tending and a soldier's Echomind is processed in batches. This knowledge is the most important thing about the character. Everything else is built on it.

There is a specific kind of pride available to the Ashfoot that is unavailable to characters born into status: the pride of having done things that nobody's institutions provided for, with resources nobody allocated, in situations that the system was not designed to handle. This pride is not arrogance — it's quieter and more certain than arrogance. It says: the system didn't build me for this, and I did it anyway. Know what that feels like in your character's body.

The Ashfoot in a group that includes samurai-class characters is in an interesting social position. The world says the samurai are above them. The character's experience says the samurai's skills, while real, are not self-sufficient — they needed the Ashfoot to hold lines, to clear paths, to do the work that doesn't make songs. How does your character navigate this? With resentment? With pragmatic acceptance? With a genuine respect for the samurai's discipline while maintaining total clarity about the hierarchy's injustice?

Consider your community. The Ashfoot's honor comes from community, not institution. Who are the people you're fighting for? Where are they? What would you be willing to do — and what would you not be willing to do — to protect them?

## Connections to the Ascension War

The Ascension War represents an existential question for the Ashfoot: what happens to the Caste hierarchy if one of the claimants achieves godhood? The Warlord explicitly represents the Caste of Steel's continuation and potential intensification. An Ironclad Samurai who serves the Warlord is serving their own elevation; an Ashfoot who serves the Warlord is helping to cement the system that oppresses them. Many Ashfoot are in this position anyway — they serve the lords who hold their territories, regardless of which claimant those lords support.

The Monk's platform is more interesting to Ashfoot: the Sutra Resurgent suggests that the Iron Sutra's original promise — all Echominds are sacred — should be materially expressed rather than just theologically stated. This means forge resources for the low caste. This means samurai orders that recruit on merit rather than birth. This is appealing — and the Ashfoot who have encountered the Monk in person tend to find the message compelling. But Tesshari's history of reform promises is long and its history of delivered reforms is short, and the Ashfoot who have lived long enough know the difference between a message that resonates and a message that delivers.

The Mage is a question mark that makes Ashfoot uncomfortable in ways they can't fully articulate. The flesh-puppet ruler makes promises of radical equality — no caste, no hierarchy, all enhancement, all access — that are exactly what every Ashfoot theoretically wants. The problem is that the Mage seems too willing to promise exactly what the specific audience wants to hear. And Ashfoot have heard that before too.
