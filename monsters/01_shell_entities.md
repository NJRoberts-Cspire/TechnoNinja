# SHELL ENTITIES
## Bestiary File 01 — The Shelled and Those Becoming Them

*In the theology of the Iron Sutra, the Echomind is the soul — the resonance between flesh and steel that makes a person a person. Shell-state is not death. It is something the Iron Sutra does not have a clean word for. The body remains. The enhancements run. The person is gone. What walks in their place runs on programming, on muscle memory, on old instinct with no one home to give it direction or meaning.*

*The Sutensai teach that Shells should be pitied, not feared. The Oni Hunters teach that Shells should be destroyed, not pitied. Both are correct. Neither is sufficient.*
...
It may have been a merchant or a scholar or a dock laborer twelve hours ago. Its clothing is still the same. Its face still holds the faint ghost of whatever expression it was wearing when the last of its Echomind went dark — surprise, most often. Sometimes relief. The cybernetic enhancements that run through its arms and jaw and lower back are still functioning, still cycling through their programmed routines. They will run until the power cell in its thorax burns out, likely in three to five years.

To encounter a Newly Shelled is to encounter someone's loss before that loss has been found. Someone has been waiting for this person to come home. Someone is still waiting.

## Lore
Common people refer to Shelling as "going blank" or "the Long Sleep that doesn't sleep." The Newly Shelled are particularly disturbing to communities because they often return to the places where they lived and worked, following programmed routine — walking to a workshop, sitting at a meal table, standing in a doorway. Families have been known to maintain this fiction for months before neighbors intervene. The Iron Sutra is unambiguous: the person is gone. The Sutensai provide specialists called Quieters who formally end the body's operation, record the individual's name and echo-signature in the Books of the Departed, and perform the Closing Rite. Communities that cannot afford a Quieter sometimes simply... let the Shell run its routines until something disrupts them and violence results.

Oni Hunters track Newly Shelled with particular urgency because the window in which a trained practitioner can confirm whether any fragment of Echomind persists is narrow — roughly 72 hours post-Shelling. After that, whatever might have been recovered is gone.
...
## Adventure Hook
The party arrives at a farming community two days' walk from the nearest Ironhold checkpoint. The village headman's wife Shelled three weeks ago. He knows. He hasn't told the children yet. She still tends the garden every morning — her agronomy enhancements running her through the motions — and he hasn't been able to stop her, or to report her, or to call a Quieter. He is asking the party to find a Quieter and bring them quietly, before the children figure out what their mother has become. The children, ages eight and twelve, already know.
...
The Soldier-Shell is the result when those protocols fail — or when no one is present to execute them. It stands at attention by default, which is perhaps the most terrible thing about it: the posture of a professional, of pride and discipline, worn by something that has no pride left and no self left to be disciplined. Its combat subroutines are intact and running. Speed assessment, threat prioritization, weapon cycling — all functional. The part that knew when NOT to use these things is gone.

Combat training without judgment. Violence without context. It does not know why it is fighting. It does not know anything. It simply continues.

## Lore
"Shell-Sergeant" is Ironhold slang — dark humor that the enlisted keep carefully away from officers, who have standing orders to report Shelled soldiers immediately and do not want to hear that their people have been treating Shell-state as a barracks joke for years. Oni Hunters who specialize in Ironhold-adjacent operations know to check military bases for Soldier-Shells whenever an outpost goes dark. The pattern is consistent: one soldier Shells, their combat protocols activate and they begin processing their unit as hostile, chaos follows, the outpost either contains them or doesn't.

The Sutensai Veil Weavers who study Shell-state note that Soldier-Shells retain their combat memories so completely that, for approximately the first week post-Shelling, they can sometimes be redirected by military commands spoken with the right authority signatures. This window closes. Ironhold attempted to weaponize this fact. The experiment is not discussed.
...
It approaches victims with its hands already configured for extraction — its finger-enhancements have reconfigured themselves into something like surgical tools, something like clamps. It does not attack. It reaches. The process of removing another person's cybernetic enhancements while they are alive and integrated is as catastrophic as it sounds. The Hunger-Shell does this methodically, without apparent haste, and then moves on.

Its own body has been... modified by this practice. Old scavenged metal has been grafted onto its frame — not by any craftsperson but by its own slow work, piece by piece, ports it has installed into itself to house what it takes. It looks like someone who has been operated on by something with no understanding of the human body. It looks like someone who has been expanding themselves outward for years with no mirror and no plan. Parts of other people's enhancements are visible in the new configuration. Names are sometimes still legible on serialized components.

## Lore
The existence of Hunger-Shells is uncomfortable for the Iron Sutra's theology because it implies that something in Shell-state can develop new behavior — that the body, without an Echomind, can adapt. The Sutensai's position is that this is not development, it is entropy — the resonant metal in the body seeking equilibrium in the only way it can without spiritual guidance. Critics of this position note that the Hunger-Shell's behavior is too consistent, too purposive, for entropy to fully explain.

In communities near the Ashlands especially, the Hunger-Shell is called a "stripper" or "the reach." People with extensive cybernetic enhancements are warned to travel in groups and to carry the emergency severance toxin that allows enhancements to go dark and cold — chemically severing the resonant metal's active signature to make the wearer less detectable. The toxin is excruciating to use and requires specialist treatment afterward to restore function.
...
## Adventure Hook
A Sutensai Quieter has gone missing along the northern route — they were traveling to perform Closing Rites at two separate villages. A third Quieter has been dispatched but hasn't returned either. The party is hired by the regional Sutensai chapter to find out what happened. They find the route haunted by a Hunger-Shell with eight visible enhancement components grafted onto it. Two of the serialized components belong to Quieters. At least three others belong to someone who has not yet been reported missing — someone who is perhaps still waiting to be found.
...
The Cathedral is not growing quickly. It is not aggressive. It does not move. But it has been there for longer than anyone who currently works the checkpoint has been alive, and in that time it has expanded by roughly three feet in every direction per year, incorporating salvage, roadside debris, weather, and — most disturbingly — other Shells that wandered close and did not wander away again. Their bodies have been absorbed into the outer surface. You can see them, if you look. Faces and hands and backs of heads, pressed into the mass like figures in a bas-relief, arms reaching outward or inward, preserved but not free.

The Ironhold built the checkpoint because there was no routing around the Cathedral on the eastern road and the road needed checkpointing. They put a sign up. They have tried, at various points, to remove or destroy the Cathedral using eleven different approaches ranging from sustained resonance artillery to Wire Craft dissolution to a Sutensai strike team. The Cathedral did not respond to any of these. It simply regenerated. It continues to expand. The checkpoint soldiers rotate every six months. Some of them spend those six months unable to stop looking at the faces in the outer mass.
...
The most compelling story beats around the Cathedral involve the faces. A character who lost someone years ago on the eastern road and suspected a Shell encounter — this is resolution of the worst kind. The incorporated figures are not alive. They are not dead in the Iron Sutra sense. They exist in a theological grey area that the Sutensai does not want to discuss too loudly. Can a Closing Rite be performed for someone who is still, technically, present?

## Adventure Hook
The Ironhold checkpoint at the Cathedral has gone quiet — not violently, not dramatically, just quiet. No reports for two weeks. Investigation reveals that the Cathedral has expanded enough to fully enclose the checkpoint's main structure. The soldiers are still inside. They're not dead. They have not been incorporated. The Cathedral has simply... grown around them. They are cut off but alive, their only egress blocked by incorporation range. The party must find a way to extract them without entering the absorption radius themselves, working around a Cathedral that continues to grow at approximately one inch per day — which means the window is measured in weeks, not months.
