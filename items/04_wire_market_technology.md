# Wire Market Technology
*Advanced devices, experimental systems, and proprietary tools from Tesshari's dominant commercial intelligence and technology network.*

---

> "The Wire Market does not sell things. The Wire Market sells advantages. This is an important distinction. An advantage has a price that changes depending on who else wants it."
>
> — Common assessment, attributed to several people simultaneously

---

## On Wire Market Items

The Wire Market operates on a tiered system:

**Open Catalog:** Items available to any buyer with sufficient currency. Listed. Priced. Delivered.

**Restricted Catalog:** Items requiring established Wire Market relationship, clearance review, or demonstrated legitimate use case. Not secret — just not advertised.

**Black Tier:** Items the Wire Market officially does not sell. Available through the Black Tier, which officially does not exist. Plausible deniability maintained on all sides.

**Experimental Tier:** Items that are not for sale because testing is not complete. Occasionally available to parties the Wire Market considers useful test subjects. Framed as an exclusive opportunity.

All Wire Market technology carries a proprietary signal stamp — a resonant-metal signature embedded in the manufacturing process that identifies the item's origin. The Wire Market can track any item they have made. They do not always exercise this capability. They always retain it.

---

# Signal Blade
*Uncommon Wire Craft Tool/Weapon | Open Catalog*

## Description

A short resonant blade — circuit-etched along the flat of the blade with a processing array, giving the weapon a faint, active glow at the edge. The glow is variable: dim under normal conditions, brighter when the signal array is engaged. The hilt contains a wire-silk interface pad that allows a user with Wire Craft access or the Threadwalker Interface enhancement to operate its secondary functions while wielding it.
...
# Null-Skin Mesh
*Rare Wire Craft Armor | Restricted Catalog*

## Description

A full-body undergarment of wire-silk woven with resonant metal filaments in a pattern that disrupts incoming signal. Looks like ordinary high-quality underbody armor when installed. Against the skin it feels like cool static — not unpleasant, but present. The wearer is always slightly aware of it.
...
# Memory Extraction Unit (MEU-7)
*Rare Wire Craft Tool | Restricted Catalog*

## Description

A handheld device slightly larger than a closed fist, in the Wire Market's standard brushed-resonant-metal casing. Two components: a reading probe (a fine resonant needle array mounted on a flexible arm, designed to interface with the signal ports behind the ears on an enhanced individual) and a storage component (a sealed resonant crystal that holds up to 72 hours of extracted memory data in compressed format).
...
**Restriction on Sale.** The MEU-7 is restricted not because the technology is unusual but because the Wire Market uses it themselves and would prefer not to have it widely available for use on Wire Market personnel.

## History and Lore

The MEU-7 is the seventh iteration of the extraction unit design. Iterations 1 through 5 caused permanent memory damage in subjects at a rate the Wire Market considered operationally problematic. Iteration 6 solved the damage issue but the extraction was incomplete — subjects reported a sensation of having been partially emptied, and the data quality was inconsistent. Iteration 7 is clean, efficient, and complete. The Wire Market is very proud of it. They use it for intelligence work, for legal disputes (Wire Market-adjudicated contracts frequently include extraction clauses), and for what their internal documentation calls "personnel compliance operations."

A used MEU-7 with data still in the crystal is on the market somewhere in the Second Reach. The data it contains is someone's worst 72 hours. Nobody has established whose.
...
# Chorus Device
*Very Rare Wire Craft Signal Tool | Restricted Catalog*
...
# Long-Wire Communicator
*Uncommon Wire Craft Signal Device | Open Catalog*

## Description

A paired set: two devices, identical in appearance. Flat, the size of a palm, with a flexible wire-silk antenna that can be concealed under clothing. Each device links to its pair through a proprietary Wire Market signal protocol — the link functions regardless of distance (within Tesshari's territory) and regardless of Wire Craft network availability. The devices communicate directly, not through the network.

The communication is text-equivalent — a resonant-pulse system that the user operates through a small interface pad. Not real-time voice. Fast text. The latency is approximately two seconds regardless of distance.
...
**Note.** The Wire Market's standard terms of service for the Long-Wire Communicator include a clause granting the Wire Market the right to monitor communications "in cases of suspected misuse." Their definition of suspected misuse is broad. Most users do not read the terms of service. Most users who do read the terms of service buy it anyway, because the alternatives are worse.
...
*Very Rare Wire Craft Environmental Tool | Experimental Tier — NOT FOR SALE*

## "We are still testing it. The testing has revealed that some test subjects experience unexpected outcomes. We are studying this."

## Description

A harness system worn across the shoulders and upper back — six resonant emitter nodes on a wire-silk frame that integrates with the wearer's enhancement system (minimum: a resonant spine node or equivalent). The harness looks like industrial work equipment and is designed to pass casual inspection as a structural analysis tool.

What it actually does: the Architect System projects a localized reality-adjustment field — a Wire Craft concept that the Wire Market's research division has been developing for twelve years and has not been able to fully explain to its own ethics board, because the ethics board keeps asking the wrong question ("how does it work") instead of the right question ("should it exist").

The adjustment field modifies physical space within a 60-foot radius around the wearer. Not dramatically. Carefully. Walls can be temporarily soft enough to pass through. Floors can be solid enough to bear weight they cannot normally support. Structures can be held together past the point where they should collapse. Structures can be encouraged to collapse at a specific moment.

The Wire Market has been testing it for architectural survey purposes. Several test subjects experienced what the documentation calls "spatial disorientation." Two test subjects experienced what the documentation calls "perceptual integration events" and what the test subjects themselves describe as "I became part of the wall and I understood the wall's perspective and the wall was afraid."
...
Not for sale. Assigned to Wire Market research test subjects only. If the party acquires one, it is either from a test subject (and the Wire Market will want it back), from a Wire Market facility (and the Wire Market will want it back urgently), or from someone who stole it (and both the thief and the party are now interesting to the Wire Market).

---

# The Soft Key
*Uncommon Wire Craft Tool | Black Tier (Officially Does Not Exist)*

## Description

A flat resonant-metal card, the size of a standard identification document, engraved on one face with a series of circuit patterns in the Wire Market's manufacturing style. The other face is blank. It is, in appearance, a medium-quality Wire Market access card.

It is not a Wire Market access card. It is a forgery engine.

The Soft Key interfaces with any Wire Market access system — door locks, restricted catalog systems, information storage nodes, personnel records — and impersonates the last valid access credential that system processed. It does not know credentials. It mirrors them. If the last person to access a system was authorized, the Soft Key impersonates their authorization level.
...
The black-market arm routes all Soft Key sales through cutouts. If the Wire Market's main operations ever officially acknowledge the Black Tier's existence, the existence of the Soft Key would be a significant problem for Wire Market credibility. Both sides are aware of this. The cutouts are well-maintained.

## History and Lore

Developed by a Wire Market internal security analyst named Haro-Sei who was testing the vulnerability of the Wire Market's own access systems. He found the vulnerability. He reported it to his supervisor. His supervisor told him to close the report and not discuss it. He complied. He then built a tool that exploited the vulnerability, because the vulnerability remained open and he wanted to understand why.

Haro-Sei has been retired for six years. He lives comfortably in the Second Reach. The Soft Key design was taken from his personal files during a security review after his retirement. He was told the design had been destroyed. He does not believe this.
...
# The Resonant Ledger
*Rare Wire Craft Information Storage Device | Restricted Catalog*

## Description

A bound volume of resonant-thread pages in a wire-silk cover. Looks like a premium journal. Functions as a Wire Craft data storage system capable of holding more information than a standard data archive in a fraction of the physical space.

The pages are written on not with ink but with signal — a Wire Craft stylus is required, included with purchase. Information recorded in the Ledger is stored in the resonant field of the pages and can be read back through the Wire Craft interface or, with significant Wire Craft skill, through tactile resonant reading (handling the pages with enhanced hands capable of resonant perception).
...
# Signal Cage
*Very Rare Wire Craft Signal Disruption Device | Restricted Catalog*

## Description

A portable device in the Wire Market's standard casing, approximately the size of a closed fist with a deployable antenna array that extends to twenty centimeters when active. The array creates a resonant disruption field — a spherical area of signal interference that blocks Wire Craft communications, disrupts enhancement-to-network connections, and interferes with signal-based targeting systems.
...
*Wire Market technology is designed to be dependable, specific, and controllable — by the Wire Market. Every item here exists in a context of commercial interest, intelligence use, and plausible deniability. The party that equips themselves from the Wire Market catalog is effective and monitored. There is no Wire Market product that does not, in some sense, serve the Wire Market.*
